...
client.on('message', message => {
	...
	} else if (message.content === `${prefix}Should you think that your friends with people who absolutaly hate you now and you left like the litteral friends dicord server`) {
		message.channel.send('Yes absolutaly ifyou dont do that you are a complete imbasil') ;
	} else if (message.content === `${prefix}what should you write to your female friends`) {
		message.channel.send('The thing is We talk cause ima guy and ura girl So it´s more interesting when it´s slightly sexual But not too sexual') ;	
	} else if (message.content === `${prefix}Is Niki Cool`) {
		message.channel.send('Yes but because he got close to byron He is now going to get ostrosized so that he doesnt like being in vc as Byron belongs to Benjamin Hans Pain and Niki is Not allowed to have Byron as Nicki isnt high enough in the rank of the Hierarchy of the Friendship group but of course he has plot convenience(plot armour)') ;
